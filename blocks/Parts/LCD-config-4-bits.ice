{
  "version": "1.2",
  "package": {
    "name": "LCD-config-4-bits",
    "version": "0.2",
    "description": "LCD-config-4-bits: Enviar los comandos de inicialización y configuración al controlador del LCD (de nivel 1). Para un LCD con interfaz de 4 bits",
